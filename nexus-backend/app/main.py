...
from app.modules.licencas import router as licencas_router
...
from app.modules.presencas import router as presencas_router
from app.modules.professores import router as professores_router
